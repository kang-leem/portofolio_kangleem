    ...
    const ContactInfo = [
        {
            ...
            icon: FaEnvelope,
            title: 'Email',
            value: 'alimalmuhaemin@gail.com',
            link: 'mailto:alimalmuhaemin@gmail.com'
        },
        {
            id: 2, 
            icon: FaPhone,
                        ...
                        <div className='bg-gray-800 rounded-lg p-6'>
                            <form>
                                <div className='mb-4'>
                                    ...
                                    <input type="email" id='email' className='w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white text-sm focus:outline-none focus:border-primary transition-colors'
                                    placeholder='alimalmuhaemin@gmail.com'
                                    recuired />
                                </div>
                                <div className='mb-6'>

    ...
    return (
       <section className='relative w-full' data-aos='zoom-in-up'>
        ...
        <div className='w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-5xl lg:max-w-7xl mx-auto relative'>
            <div className='grid lg:grid-cols-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w 2xl md:max-w-3xl mx-auto'>
                ...
                <div className='lg:h-full md:flex'>
                    <div className='flex w-full h-96 min-h-96 lg:min-h-[none] lg:w=full lg:h-full items-center relative'>
                        <div className='absolute z-0 top-1/2-translate-y-1/2 w-5/6 right-0 h-[calc(80%+20px)]
                        bg-linear-to-r opacity-25 from-[#0c64ac] to-primary blur-2xl'>
                        </div>
                        <div className='absolute h-full z-10 p-2-translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-[30%_70%_70%_30%_/30%_30%_70%_70%] shadow-lg border border-cyan-500'>

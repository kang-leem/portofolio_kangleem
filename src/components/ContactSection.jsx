    ...
    const contactInfo = [
        {
            ...
            icon: FaEnvelope,
            title: 'Email',
            value: 'alimalmuhaemin@gmail.com',
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mb-8 leading-relaxed">
                            Contact me for problem resolution.
                        </p>
                                        ...
                                        <div>
                                            ...
                                            {info.link ? (
                                                <a
                                                    ...
                                                    target={info.title === 'Email' || info.title === 'LinkedIn' ? '_blank' : undefined}
                                                    rel={info.title === 'Email' || info.title === 'LinkedIn' ? 'noopener noreferrer' : undefined}
                                                >
                                                    {info.value}
                                                </a>
                                            ) : (
